...
void SimpleShapeApplication::init() {
    ...
    glm::mat4 V = glm::lookAt(glm::vec3(0.0f, 0.0f, 2.0f),
    ...
    OGL_CALL(glNamedBufferData(u_buffer_handle_0, 16 * sizeof(float), NULL, GL_STATIC_DRAW));
    OGL_CALL(glNamedBufferSubData(u_buffer_handle_0, 0 * sizeof(float), 16 * sizeof(float), &PVM[0]));
