...
void SimpleShapeApplication::init() {
    ...
    glm::mat4 P = glm::perspective(glm::radians(45.0f),
                  static_cast<float>(frame_buffer_size().first) / static_cast<float>(frame_buffer_size().second), 0.1f, 20.0f);
    glm::mat4 V = glm::lookAt(glm::vec3(0.0f, -2.0f, 2.0f),
    ...
    OGL_CALL(glNamedBufferData(u_buffer_handle_1, 16 * sizeof(float), NULL, GL_STATIC_DRAW));
    OGL_CALL(glNamedBufferSubData(u_buffer_handle_1, 0 * sizeof(float), 16 * sizeof(float), &PVM[0]));
